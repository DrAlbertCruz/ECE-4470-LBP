        ...
        for image_file in os.listdir(category_path):
            ...
            if image_file.endswith(('.jpg', '.jpeg', '.png', '.bmp')):
                ...
                if image is not None:
                    ...
                    image_data[sample_count,0:256] = compute_lbp_histogram(image)
                    image_data[sample_count,256:] = compute_histogram(image)
...
X_train, X_test, y_train, y_test = train_test_split(image_data, encoded_labels, test_size=train_percent, random_state=1)
